...
namespace EjercicioEjercito
{
    public class Fabrica : IFabricaElementos
    {
        public ICaracteristicas DameElemento(TipoElementos tipo)
        {
            ...
            switch (tipo)
            {
                case TipoElementos.TransporteMX: elemento = new Unidad() 
                { 
                ...
                case TipoElementos.Tanque: elemento = new Unidad()
                { 
                ...
                case TipoElementos.TransporteRapido: elemento = new Unidad() 
                { 
                ...
                case TipoElementos.Infanteria: elemento = new Unidad() 
                { 
                    blindaje = new NoEstaBlindado() { Blindaje = 0 }, 
                ...
                case TipoElementos.Ametrallador: elemento = new Unidad()
                { 
                ...
                case TipoElementos.Sanitario: elemento = new Unidad() 
                { 
                    blindaje = new EstaBlindado() { Blindaje = 1.4 }, 
                    potencia = new NoDispara() { PotenciaFuego = 0 }, 
                    velocidad = new SeMueve() { Velocidad = 4.5 }, 
                ...
                case TipoElementos.CanonAntiaereo: elemento = new Unidad() 
                { 
                    blindaje = new NoEstaBlindado() { Blindaje = 1.4 }, 
                    potencia = new Dispara() { PotenciaFuego = 0 }, 
                    velocidad = new SeMueve() { Velocidad = 4.5 }, 
                ...
                case TipoElementos.Torpedero: elemento = new Unidad()
                { 
                    blindaje = new EstaBlindado() { Blindaje = 1.4 }, 
                    potencia = new Dispara() { PotenciaFuego = 0 }, 
                    velocidad = new SeMueve() { Velocidad = 4.5 }, 
                ...
                case TipoElementos.Canon: elemento = new Unidad()
                { 
                    blindaje = new NoEstaBlindado() { Blindaje = 1.4 }, 
                    potencia = new NoDispara() { PotenciaFuego = 0 }, 
